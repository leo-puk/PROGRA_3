...
import pe.edu.pucp.techshopper.daoImp.util.Tipo_Operacion;
...
public abstract class DAOImplBase {
    ...
    private Integer ejecuta_DML(Tipo_Operacion tipo_Operacion) {
        ...
        try {
            ...
            } else if (tipo_Operacion == Tipo_Operacion.MODIFICAR) {
                sql = this.generarSQLParaModificacion();
            } else if (tipo_Operacion == Tipo_Operacion.ELIMINAR) {
