...
public class Carritos {
    ...
    public Integer crearCarrito(@WebParam(name = "idCliente") Integer idCliente) {
    ...
    public Integer eliminarCarrito(@WebParam(name = "idCarrito") Integer idCarrito) {
        return carritoBO.eliminarCarrito(idCarrito);
    }

    @WebMethod(operationName = "obtenerCarritoPorId")
    public CarritoDTO obtenerCarritoPorId(@WebParam(name = "idCarrito") Integer idCarrito) {
    ...
    public Double montoAPagar(@WebParam(name = "idCarrito") Integer idCarrito) {
