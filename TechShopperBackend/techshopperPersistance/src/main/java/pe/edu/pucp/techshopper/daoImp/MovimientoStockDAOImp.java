...
public class MovimientoStockDAOImp extends DAOImplBase implements MovimientoStockDAO {
    ...
    protected void configurarListaDeColumnas() {
        ...
        this.listaColumnas.add(new Columna("MOTIVO", Tipo_Dato.CADENA, false, false));
    ...
    protected void incluirValorDeParametrosParaInsercion() throws SQLException {
        ...
        this.statement.setString(5, this.movimiento.getMotivo());
        
        if (this.movimiento.getUsuario() != null) {
            this.statement.setInt(6, this.movimiento.getUsuario().getIdUsuario());
        } else {
    ...
    protected void incluirValorDeParametrosParaModificacion() throws SQLException {
        ...
        this.statement.setInt(7, this.movimiento.getIdMovimiento());
    }
    ...
    protected void instanciarObjetoDelResultSet() throws SQLException {
        ...
        try {
            ...
            this.movimiento.setTipo(TipoMovimientoDTO.AJUSTE);
        }
        ...
        this.movimiento.setMotivo(this.resultSet.getString("MOTIVO"));
