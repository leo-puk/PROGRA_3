<%@ Page Title="" Language="C#" MasterPageFile="~/InicionSesion/InicioSesion.Master" AutoEventWireup="true" CodeBehind="RegistroCliente.aspx.cs" Inherits="TechShopperWA.InicionSesion.RegistroCliente" %>
            ...
            <div class="col-lg-6 col-md-8">
                <div class="card shadow-lg border-0" style="border-radius: 15px; overflow: hidden;">
                    <div class="card-header py-3" style="background-color: #835da2;">
                        <h2 class="text-center mb-0 text-white"><i class="fa fa-user-plus me-1"></i>REGISTRO DE CLIENTE</h2>
                    </div>
                    <div class="card-body p-4" style="background-color: #f8f9fa;">
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold" style="color: #835da2;">Dirección</label>
                            <asp:TextBox ID="txtDireccion" runat="server" CssClass="form-control form-control-lg" placeholder="Ingrese su dirección" />
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-bold" style="color: #835da2;">Teléfono</label>
                            <asp:TextBox ID="txtTelefono" runat="server" CssClass="form-control form-control-lg" placeholder="Ingrese su número de teléfono" />
                        </div>
