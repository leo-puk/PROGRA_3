...
public class AdministradorDAOImp  extends BaseDAOImp <AdministradorDTO> implements AdministradorDAO {
    ...
    protected String getInsertarQuery() {
        return  "insert into administrador (contraseña, estadoConexion,fechaRegistro,nombre,email) values (?,?,?,?,?)";
    }

    @Override
    protected String getUpdateQuery() {
       return  "update administrador SET contraseña = ?, estadoConexion = ?,fechaRegistro = ?,nombre = ?,email = ? where idAdministrador = ?";
    }

    @Override
    protected String getSelectByIdQuery() {
        return "select * from administrador WHERE idAdministrador = ?";
    }
    ...
    protected String getDeleteQuery() {
        return "delete from administrador WHERE idAdministrador = ?";
    }
